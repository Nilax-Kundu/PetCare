    ...
    <div class="container mx-auto px-6">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><a href="p1/chatbot.html" class="text-gray-400 hover:text-white transition-colors">Pet Care Tips</a></li>
            <li><a href="p1/blog.html" class="text-gray-400 hover:text-white transition-colors">Blog</a></li>
            <li><a href="p1/faq.html" class="text-gray-400 hover:text-white transition-colors">FAQs</a></li>
      ...
      <div class="mt-12 pt-8 border-t border-gray-800 text-center">
        ...
        <div class="mt-4 flex justify-center space-x-6">
          <a href="PrivacyPolicy.html" class="text-gray-400 hover:text-white transition-colors">Privacy Policy</a>
          <a href="tos.html" class="text-gray-400 hover:text-white transition-colors">Terms of Service</a>
